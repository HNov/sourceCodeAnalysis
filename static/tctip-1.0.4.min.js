!function(t, e) {
    ...
    , function(t, e, n) {
        ...
        function i(t) {
            t.button || (t.button = c);
            var e = t.button;
            e.imageUrl || (e.id || (e.id = c.id),
            e.type && (0,
            A.inArray)(e.type, s) || (e.type = c.type),
        ...
        function o(t) {
            ...
            var e = []
              ...
              , o = void 0;
            try {
                for (var a, u = t.list[Symbol.iterator](); !(r = (a = u.next()).done); r = !0) {
                    var s = a.value;
                    if (!s.type) {
                    ...
                    var c = s.type;
                    if (l.hasOwnProperty(c) && (0,
                    A.mergeObject)(s, l[c], !0),
        ...
        var r, i, o, A = function() {
            ...
            var e = function(e, n) {
                var i = 236
                  ...
                  , w = function(t, e) {
                    for (var n = -1; n <= 7; n += 1)
                        if (!(t + n <= -1 || b <= t + n))
                            for (var r = -1; r <= 7; r += 1)
                                e + r <= -1 || b <= e + r || (g[t + n][e + r] = 0 <= n && n <= 6 && (0 == r || 6 == r) || 0 <= r && r <= 6 && (0 == n || 6 == n) || 2 <= n && n <= 4 && 2 <= r && r <= 4)
                }
                  , I = function() {
                    ...
                    for (var t = o.getPatternPosition(h), e = 0; e < t.length; e += 1)
                        for (var n = 0; n < t.length; n += 1) {
                            ...
                            if (null == g[r][i])
                                for (var A = -2; A <= 2; A += 1)
                                    for (var a = -2; a <= 2; a += 1)
                                        g[r + A][i + a] = A == -2 || 2 == A || a == -2 || 2 == a || 0 == A && 0 == a
                        }
                }
                  , k = function(t) {
                  ...
                  , D = function(t, e) {
                    for (var n = p << 3 | e, r = o.getBCHTypeInfo(n), i = 0; i < 15; i += 1) {
                        var A = !t && 1 == (r >> i & 1);
                        i < 6 ? g[i][8] = A : i < 8 ? g[i + 1][8] = A : g[b - 15 + i][8] = A
                    }
                    for (var i = 0; i < 15; i += 1) {
                        var A = !t && 1 == (r >> i & 1);
                        i < 8 ? g[8][b - i - 1] = A : i < 9 ? g[8][15 - i - 1 + 1] = A : g[8][15 - i - 1] = A
                    }
                    g[b - 8][8] = !t
                }
                  , j = function(t, e) {
                    for (var n = -1, r = b - 1, i = 7, A = 0, a = o.getMaskFunction(e), u = b - 1; u > 0; u -= 2)
                        for (6 == u && (u -= 1); ; ) {
                            for (var s = 0; s < 2; s += 1)
                                if (null == g[r][u - s]) {
                                    var c = !1;
                  ...
                  , B = function(e, n) {
                    for (var r = 0, i = 0, A = 0, a = new Array(n.length), u = new Array(n.length), s = 0; s < n.length; s += 1) {
                        var c = n[s].dataCount
                          , f = n[s].totalCount - c;
                        i = Math.max(i, c),
                        A = Math.max(A, f),
                    ...
                    for (var y = new Array(d), v = 0, l = 0; l < i; l += 1)
                        for (var s = 0; s < n.length; s += 1)
                            l < a[s].length && (y[v] = a[s][l],
                            v += 1);
                    for (var l = 0; l < A; l += 1)
                        for (var s = 0; s < n.length; s += 1)
                            l < u[s].length && (y[v] = u[s][l],
                            v += 1);
                    return y
                }
                  , Z = function(t, e, n) {
                    for (var r = a.getRSBlocks(t, e), s = u(), c = 0; c < n.length; c += 1) {
                        var f = n[c];
                        s.put(f.getMode(), 4),
                ...
                m.createSvgTag = function(t, e) {
                    t = t || 2,
                    e = void 0 === e ? 4 * t : e;
                    var n, r, i, o, A, a = m.getModuleCount() * t + 2 * e, u = "";
                    ...
                    i = 0; i < m.getModuleCount(); i += 1)
                        ...
                        n = 0; n < m.getModuleCount(); n += 1)
                            ...
                            u += "M" + r + "," + o + A);
                    return u += '" stroke="transparent" fill="black"/>',
                    u += "</svg>"
                }
                ,
            ...
            var n = {
                    ...
                    for (var e = t.getModuleCount(), n = 0, r = 0; r < e; r += 1)
                        for (var i = 0; i < e; i += 1) {
                            for (var o = 0, A = t.isDark(r, i), a = -1; a <= 1; a += 1)
                                if (!(r + a < 0 || e <= r + a))
                                    for (var u = -1; u <= 1; u += 1)
                                        i + u < 0 || e <= i + u || 0 == a && 0 == u || A == t.isDark(r + a, i + u) && (o += 1);
                            o > 5 && (n += 3 + o - 5)
                        }
              ...
              , a = function() {
                ...
                return n.getRSBlocks = function(t, n) {
                    ...
                    for (var o = r.length / 3, A = new Array, a = 0; a < o; a += 1)
                        for (var u = r[3 * a + 0], s = r[3 * a + 1], c = r[3 * a + 2], f = 0; f < u; f += 1)
                            A.push(e(s, c));
                    return A
                }
                ,
              ...
              , b = function(t, e) {
                ...
                var A = function(t) {
                  ...
                  , a = function(t) {
                    for (var e = 1 << t, n = (1 << t) + 1, r = t + 1, o = u(), a = 0; a < e; a += 1)
                    ...
                    for (f += 1; f < i.length; ) {
                        ...
                        f += 1,
                        o.contains(l + p) ? l += p : (c.write(o.indexOf(l), r),
                        o.size() < 4095 && (o.size() == 1 << r && (r += 1),
                        o.add(l + p)),
                        l = p)
                    }
                    return c.write(o.indexOf(l), r),
                    c.write(n, r),
                    c.flush(),
                    s.toByteArray()
                }
              ...
              , d = function(t, e, n, r) {
                ...
                var a = h();
                i.write(a);
                for (var u = p(), s = a.toByteArray(), c = 0; c < s.length; c += 1)
                    u.writeByte(s[c]);
                u.flush();
                var f = "";
                return f += "<img",
