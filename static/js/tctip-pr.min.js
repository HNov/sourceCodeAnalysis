...
var tctip = window.tctip || {
    ...
    generateMyRewardsMain: function() {
        ...
        var myRewardsBot = tctipUtil.createElement({
            className: "myR-bot"
        }, "p", this.myRewardsMain);
        obj = {
            href: tctip.myConfig.buttomLink || "https://github.com/HaddyYang/tctip",
            target: "_blank"
        };
        obj[tctipUtil.getTextKey()] = tctip.myConfig.buttomText || "博客(Gitee)";
    ...
    generateMyRewardsList: function() {
        ...
        if (tctip.myConfig.list.length >= 5) {
            ...
            this.myRewardsListUl = tctipUtil.createElement({
                className: "not-full"
        ...
        for (var i = 0; i < 5; i++) {
            ...
            var li_el = tctipUtil.createElement({
    ...
    generateMyRewardsDetail: function() {
        ...
        if (tctip.currentData.hasOwnProperty("text")) {
            ...
            var myRewardsCode = tctipUtil.createElement({
