!function(t, e) {
    ...
    , function(t, e) {
        t.exports = {
            ...
            keywords: ["tctip", "tip", "惊喜", "插件library", "javascript"],
            ...
            a(e, [{
                ...
                value: function() {
                    ...
                    this.createDom({
                        ...
                        onclick: function() {
                            "240px" === t.parentDom.dom.style.width ? t.parentDom.hide() : t.parentDom.show()
                        },
                        href: "javascript:;"
                    }, "a"),
          ...
          , v = function(t) {
            ...
            c(e, [{
                ...
                value: function() {
                    ...
                    h.default)(this.config.qrContent) : console.error("没有可展示的二维码")
                }
            }]),
            e
        }(s.default)
    ...
    , function(t, e) {
        ...
        n.prototype.addListener = function(t, e) {
            ...
            o(this._events[t]) && !this._events[t].warned && (i = A(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners) && i > 0 && this._events[t].length > i && (this._events[t].warned = !0,
        ...
        var r, i, o, A = function() {
            ...
            var e = function(e, n) {
                var i = 236
                  ...
                  , w = function(t, e) {
                    for (var n = -1; n <= 7; n += 1)
                        if (!(t + n <= -1 || d <= t + n))
                            for (var r = -1; r <= 7; r += 1)
                                e + r <= -1 || d <= e + r || (g[t + n][e + r] = 0 <= n && n <= 6 && (0 == r || 6 == r) || 0 <= r && r <= 6 && (0 == n || 6 == n) || 2 <= n && n <= 4 && 2 <= r && r <= 4)
                }
                  , I = function() {
                  ...
                  , M = function() {
                    for (var t = o.getPatternPosition(h), e = 0; e < t.length; e += 1)
                        for (var n = 0; n < t.length; n += 1) {
                            ...
                            if (null == g[r][i])
                                for (var A = -2; A <= 2; A += 1)
                                    for (var a = -2; a <= 2; a += 1)
                                        g[r + A][i + a] = -2 == A || 2 == A || -2 == a || 2 == a || 0 == A && 0 == a
                        }
                }
                  , D = function(t) {
                  ...
                  , B = function(t, e) {
                    for (var n = p << 3 | e, r = o.getBCHTypeInfo(n), i = 0; i < 15; i += 1) {
                        var A = !t && 1 == (r >> i & 1);
                  ...
                  , j = function(e, n) {
                    for (var r = 0, i = 0, A = 0, a = new Array(n.length), c = new Array(n.length), u = 0; u < n.length; u += 1) {
                        ...
                        r += s;
                        var h = o.getErrorCorrectPolynomial(l)
                          , p = t(a[u], h.getLength() - 1)
                          , g = p.mod(h);
                    ...
                    for (var b = 0, f = 0; f < n.length; f += 1)
                        b += n[f].totalCount;
                    for (var y = new Array(b), v = 0, f = 0; f < i; f += 1)
                        for (var u = 0; u < n.length; u += 1)
                            f < a[u].length && (y[v] = a[u][f],
                            v += 1);
                    for (var f = 0; f < A; f += 1)
                        for (var u = 0; u < n.length; u += 1)
                            f < c[u].length && (y[v] = c[u][f],
                            v += 1);
                    return y
                }
                  , U = function(t, e, n) {
                ...
                m.make = function() {
                    if (h < 1) {
                        for (var t = 1; t < 40; t++) {
                            for (var e = a.getRSBlocks(t, p), n = c(), r = 0; r < v.length; r++) {
                                var i = v[r];
                                n.put(i.getMode(), 4),
                                n.put(i.getLength(), o.getLengthInBits(i.getMode(), t)),
                                i.write(n)
                            }
                ...
                m.createSvgTag = function(t, e) {
                    t = t || 2,
                    e = void 0 === e ? 4 * t : e;
                    var n, r, i, o, A, a = m.getModuleCount() * t + 2 * e, c = "";
                    ...
                    i = 0; i < m.getModuleCount(); i += 1)
                        for (o = i * t + e,
                        n = 0; n < m.getModuleCount(); n += 1)
                            m.isDark(i, n) && (r = n * t + e,
                            c += "M" + r + "," + o + A);
            ...
            e.stringToBytes = e.stringToBytesFuncs.default,
            ...
            var n = {
              ...
              , o = function() {
                ...
                return a.getBCHTypeInfo = function(t) {
                    for (var e = t << 10; c(e) - c(r) >= 0; )
                        e ^= r << c(e) - c(r);
                    return 21522 ^ (t << 10 | e)
                }
                ,
                a.getBCHTypeNumber = function(t) {
                    for (var e = t << 12; c(e) - c(o) >= 0; )
                        e ^= o << c(e) - c(o);
                    return t << 12 | e
                }
                ,
              ...
              , d = function(t, e) {
                ...
                var A = function(t) {
                  ...
                  , a = function(t) {
                    for (var e = 1 << t, n = 1 + (1 << t), r = t + 1, o = c(), a = 0; a < e; a += 1)
                    ...
                    for (l += 1; l < i.length; ) {
                        ...
                        l += 1,
                        o.contains(f + p) ? f += p : (s.write(o.indexOf(f), r),
              ...
              , b = function(t, e, n, r) {
                ...
                var a = h();
                i.write(a);
                for (var c = p(), u = a.toByteArray(), s = 0; s < u.length; s += 1)
                    c.writeByte(u[s]);
                c.flush();
                var l = "";
                return l += "<img",
            ...
            A.stringToBytesFuncs["UTF-8"] = function(t) {
                function e(t) {
                    for (var e = [], n = 0; n < t.length; n++) {
                        var r = t.charCodeAt(n);
                        r < 128 ? e.push(r) : r < 2048 ? e.push(192 | r >> 6, 128 | 63 & r) : r < 55296 || r >= 57344 ? e.push(224 | r >> 12, 128 | r >> 6 & 63, 128 | 63 & r) : (n++,
